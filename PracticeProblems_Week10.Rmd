...
### (f) In most cases, two classification trees will make different predictions for some new observations. Using the classification trees you built in parts (b) and (c), fill in the table below with values which would lead the the specified predictions.
...
-------------------------------------------------------------------------------------
Node    Proportion of "Yes" values in each node   Prediction 
----    ---------------------------------------   -----------------------------------
1                                                
